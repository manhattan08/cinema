...
export default function ConfirmPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!password.one.trim())
            return updateNotification('error', 'Password is mising!')
      ...
      <FormContainer>
        <Container>
          <form onSubmit={handleSubmit} className={commonModalClasses+ " w-96"}>
            ...
            <FormInput value={password.one} onChange={handleChange} label="New Password" placeholder="***********" name="passwordOne" type='password'/>
            <FormInput value={password.two} onChange={handleChange} label="Confirm Password" placeholder="***********" name="passwordTwo" type='password'/>
